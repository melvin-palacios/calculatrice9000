...
formule_field.grid(columnspan=4, pady=0, padx=0, ipadx=100, ipady=38,)
...
inverse = Button(master, text='²', command=lambda: click('**2'), height=2, width=10)
inverse.grid(row=6, column=2)

memo = Button(master, text='√', command=lambda: click('**0.5'), height=2, width=10)
